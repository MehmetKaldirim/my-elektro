    ...
    <div className="bg-white text-black p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold mb-2">Leistung Eins</h2>
        ...
        <div className="flex flex-col items-center">
          ...
          />
          <h2 className="text-xl font-semibold mb-2">Leistung Zwei</h2>
          <p className="text-gray-500 text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
            eiusmod tempor incididunt.
          </p>
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-16 h-16 mb-4"
          />
          <h2 className="text-xl font-semibold mb-2">Leistung Drei</h2>
          <p className="text-gray-500 text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
            eiusmod tempor incididunt.
          </p>
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-16 h-16 mb-4"
          />
          <h2 className="text-xl font-semibold mb-2">Leistung Vier</h2>
          <p className="text-gray-500 text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
            eiusmod tempor incididunt.
          </p>
